<template>
  <div class="house-info" id="house-info">
    ...
    <div class="content">
      <div class="logo">
        <div class="logo_box">
          <img class="logo_title" src="@/projects/lishu/house_info/name.png" />
          <div class="logo_link">
            <a target="_blank" href="https://unigiants.com.tw/"><img src="@/projects/lishu/house_info/icon1.png"/></a>
            <a target="_blank" href="https://www.facebook.com/unigiant/"><img src="@/projects/lishu/house_info/icon2.png"/></a>
          </div>
        </div>
        <img v-if="!isMobile" class="logo_logo" src="@/projects/lishu/house_info/logo.png" />
      </div>
      <div class="msg">
        ...
        <img v-if="isMobile" class="msg_logo" src="@/projects/lishu/house_info/logo.png" />
      </div>
    </div>
    <Footer />
  </div>
